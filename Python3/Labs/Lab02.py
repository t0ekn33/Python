"""Lab 02
Go back and change the last lab to open both files in a with statement.
Remember, this precludes the need to close the file. My version of the
last lab is available online.
"""
