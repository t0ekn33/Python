...
unload_dict = words.items()  # unload dictionary into an iterator of
                             # key/value tuples
# Sort this iterator based on the 2nd entry in each tuple and then reverse
# the result.
...
for word, count in sort_unload[0:20]: # process just the top 20 items
