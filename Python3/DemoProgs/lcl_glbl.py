...
dir() poduces the names for that namespace.  local() produces the
namespace names and values in the form of a dictionary.  The global
statement allows the function to act on global variables without causing
problems for the main program.  It is generally considered a crutch for
bad code.
...
print('Globals:')
pprint(dir())
# pprint(globals()) # In the main program globals() & locals() are the same
print('\nContents of Globals:')
pprint(locals())
print('\n\n')
lcl_tst(x, y)
